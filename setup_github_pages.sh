...
# 🚀 Script de Configuração Rápida para GitHub Pages - João Manoel
# Este script automatiza o processo de envio do Jarvis para GitHub Pages

echo "🤖 JARVIS - Setup GitHub Pages"
echo "================================="
...
if git push -u origin main 2>/dev/null; then
    ...
    echo "⚠️ Primeira tentativa falhou, tentando forçar..."
